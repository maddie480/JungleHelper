...
@mapdef Entity "JungleHelper/RollingRock" RollingRock(x::Integer, y::Integer, cracked::Bool=false, spriteXmlName::String="", debrisSpriteDirectory::String="JungleHelper/RollingRock", flag::String="")
